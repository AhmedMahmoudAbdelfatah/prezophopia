    ...
    return (
        <div className='friend-info'>
            ...
            <div className="image-name">
                <div className="image">
                <img src={`http://localhost:8080/${currentfriend.image_url}`} alt="cur-frind"/>
                </div>
                 {
                    activeUser && activeUser.length>0 && activeUser.some(u=>u === currentfriend._id)?<div className="active-user">Active</div>:''
                }
